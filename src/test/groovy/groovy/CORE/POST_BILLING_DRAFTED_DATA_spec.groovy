...
import groovy.US.POST_BILLING_DRAFTED_DATA
...
class POST_BILLING_DRAFTED_DATA_spec extends Specification {
	
	def "postBillingDrafteddataSuccess"(){
		...
		when:
			...
			POST_BILLING_DRAFTED_DATA.newInstance().execute(domain)
	...
	def "postBillingDrafteddataException"(){
				...
				given:
					...
					def entityService = [create: {String collectionName, Map m1 -> entityResult},
						updateByQuery: {String arg0, Map<String, Object> arg1, Map<String, Object> arg2 -> entityResult}
						] as GSSPEntityService
			...
			def "postBillingDrafteddataFailure"(){
